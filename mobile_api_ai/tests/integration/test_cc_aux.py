...
_PATCHED_MODULES = {
    ...
    'container_center.desktop_callback': types.ModuleType('container_center.desktop_callback'),
    'services.instruction_handler': types.ModuleType('services.instruction_handler'),
    'integration.instruction_handler': types.ModuleType('integration.instruction_handler'),
